...
function SwitzerlandPhotoBigger2() {
  return (
    <div>
      <Navbar />
      <div className="bg-gray-100 min-h-screen flex flex-col items-center justify-center">
        <h1 className="text-3xl text-blue-600 font-semibold mb-8">Switzerland Photo 2 - Bigger</h1>
        ...
        <div className="nav mt-8">
          ...
          <a href="/#/switz3" className="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 ml-4">Next</a>
        </div>
      </div>
    </div>
  );
...
export default SwitzerlandPhotoBigger2;
