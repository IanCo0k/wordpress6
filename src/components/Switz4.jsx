    ...
    <div>
      ...
      <div className="bg-gradient-to-b from-blue-200 to-blue-300 min-h-screen">
        <div className="container mx-auto p-8">
          <h1 className="text-3xl font-semibold text-center text-white mb-4">Switzerland Photo 4</h1>
          <a href='/#/switz4-bigger' className="block mx-auto max-w-md">
          ...
          <div className="mt-8 flex justify-center">
            ...
            <a href="/#/switz5" className="text-blue-600 hover:underline text-xl">
              Next Page
            </a>
          </div>
        </div>
